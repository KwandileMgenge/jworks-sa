    ...
    <div className="footer-grid">
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
          ...
          <div className="logo-text" style={{ fontSize: 23 }}>
            J WORKS<span>-SA</span>
          </div>
        </div>
        <p className="footer-tagline">
          ...
          {BRAND.slogan}
          <br />
          Construction · Home Improvements · Energy &amp; Fuel Supply
          <br />
      ...
      <div>
        <div className="footer-col">
          ...
          <div className="f-contact-item">
            ✉️ <a href={`mailto:${BRAND.emails.director}`}>{BRAND.emails.director}</a>
          </div>
          <div className="f-contact-item">
            ✉️ <a href={`mailto:${BRAND.emails.primary}`}>{BRAND.emails.primary}</a>
          </div>
          <div className="f-contact-item">
            🌐{" "}
